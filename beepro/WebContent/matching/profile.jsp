...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="index.html">logo name</a>
      ...
      <div class="collapse navbar-collapse" id="">
        <ul class="navbar-nav text-uppercase ml-auto">
          <li class="nav-item">
            ...
            <ul class="sub-nav">
              <li><a class="nav-link" href="project.html">by project</a></li>
              <li><a class="nav-link" href="personal.html">by personal</a></li>
            </ul>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="profile.html">로그인</a>
          </li>
        </ul>
      </div>
    </div>
