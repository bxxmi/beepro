...
ALTER TABLE beepro_user ADD CONSTRAINT PK_BEEPRO_USER PRIMARY KEY (
	user_seq
);
...
ALTER TABLE heart ADD CONSTRAINT FK_beepro_user_TO_heart_1 FOREIGN KEY (
	send_heart
)
REFERENCES beepro_user (
	user_seq
);

ALTER TABLE heart ADD CONSTRAINT FK_beepro_user_TO_heart_2 FOREIGN KEY (
	get_heart
)
REFERENCES beepro_user (
	user_seq
...
ALTER TABLE comments ADD CONSTRAINT FK_issue_TO_comments_1 FOREIGN KEY (
	issue_seq,
    project_seq
)
REFERENCES issue (
...
ALTER TABLE matching_personal ADD CONSTRAINT FK_user_TO_match_personal FOREIGN KEY (
	user_seq
)
REFERENCES beepro_user (
	user_seq
...
ALTER TABLE matching_project ADD CONSTRAINT FK_user_TO_match_project FOREIGN KEY (
	pm_seq
)
REFERENCES beepro_user (
	user_seq
...
ALTER TABLE skill ADD CONSTRAINT FK_match_per_TO_skill_1 FOREIGN KEY (
	personal_seq,
    uesr_seq
)
...
ALTER TABLE project_member ADD CONSTRAINT FK_project_TO_project_mem FOREIGN KEY (
	project_seq
)
REFERENCES project (
	project_seq
...
ALTER TABLE project_member ADD CONSTRAINT FK_user_TO_project_mem FOREIGN KEY (
	member_seq
)
REFERENCES beepro_user (
	user_seq
